...
from wizard.deck import FilteredDeck, Deck
from wizard.game import PredefinedGameForFirstPlayer
...
class GameManagerTwoCardsFirstPlayer(GameManager):
    ...
    def simulate(self):
        ...
        deck = Deck(deck_id=1)
        hand_two_cards = HandCombinationsTwoCards(
            trump_color=deck.get_colors[0],
            base_color1=deck.get_colors[1],
            base_color2=deck.get_colors[2],
        )
        possibilities_for_first_player_to_test = hand_two_cards.possibilities_to_test(
            deck
        )
        for possibility in possibilities_for_first_player_to_test:
            ...
            for trial in range(self.number_trial):
                ...
                for prediction in range(NUMBER_CARDS_PER_PLAYER + 1):
                    game = PredefinedGameForFirstPlayer(
                        id_game=1,
                    ...
                    for player_1_first_card_to_play in [0, 1]:
                        for player_2_first_card_to_play in [0, 1]:
                            for player_3_first_card_to_play in [0, 1]:
                                player1 = DecidePlayer(
                                    id=1, first_card_to_play=player_1_first_card_to_play
                                )
                                player2 = DecidePlayer(
                                    id=2, first_card_to_play=player_2_first_card_to_play
                                )
                                player3 = DecidePlayer(
                                    id=3, first_card_to_play=player_3_first_card_to_play
                                )
                                players = [player1, player2, player3]
                                filtered_deck.reset_deck()
                                game.start_game(
                                    filtered_deck, players, first_player=player1
                                )
                                game.make_predictions()
                                game.play_game(log=False)

                                points = game.count_points()[game.players[0]]
                                if (player_1_first_card_to_play == 0) & (
                                    points < worst_points_gain_first_card_play
                                ):
                                    worst_points_gain_first_card_play = points
                                elif (player_1_first_card_to_play == 1) & (
                                    points < worst_points_gain_second_card_play
                                ):
                                    worst_points_gain_second_card_play = points
                    worst_points_gain_per_prediction_first_card_play[
                        prediction
                    ] = worst_points_gain_first_card_play
                    worst_points_gain_per_prediction_second_card_play[
                        prediction
                    ] = worst_points_gain_second_card_play
                list_worst_points_gain_per_prediction_first_card_play += [
                    worst_points_gain_per_prediction_first_card_play
                ]
                list_worst_points_gain_per_prediction_second_card_play += [
            ...
            summary = summary.append(
                {
                    "first_card": possibility[0].prepare_card_for_display(),
                    "second_card": possibility[1].prepare_card_for_display(),
                    "prediction_0_worst_average_gain_first_card_play": mean_per_prediction_first_card_play[
                        0
                    ],
                    "prediction_1_worst_average_gain_first_card_play": mean_per_prediction_first_card_play[
                        1
                    ],
                    "prediction_2_worst_average_gain_first_card_play": mean_per_prediction_first_card_play[
                        2
                    ],
                    "prediction_0_worst_average_gain_second_card_play": mean_per_prediction_second_card_play[
                        0
                    ],
                    "prediction_1_worst_average_gain_second_card_play": mean_per_prediction_second_card_play[
                        1
                    ],
                    "prediction_2_worst_average_gain_second_card_play": mean_per_prediction_second_card_play[
                        2
                    ],
                },
                ignore_index=True,
            )
        summary["best_outcome_prediction_0"] = summary[
            [
                "prediction_0_worst_average_gain_first_card_play",
                "prediction_0_worst_average_gain_second_card_play",
            ]
        ].values.max(1)
        summary["best_outcome_prediction_1"] = summary[
            [
                "prediction_1_worst_average_gain_first_card_play",
                "prediction_1_worst_average_gain_second_card_play",
            ]
        ].values.max(1)
        summary["best_outcome_prediction_2"] = summary[
            [
        ...
        summary = summary[
            [
                "first_card",
                "second_card",
                "best_outcome_prediction_0",
                "best_outcome_prediction_1",
