...
NUMBER_OF_COLORS = 4
NUMBER_OF_CARDS = (
    len(SUITS) * len(BASE_COLORS) + NUMBER_OF_JESTERS + NUMBER_OF_MAGICIANS
)
NUMBER_OF_UNIQUE_CARDS = (
    len(SUITS) * len(BASE_COLORS) + 2
)  # TODO: Handle edge case where no magician/jester
