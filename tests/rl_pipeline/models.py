...
from wizard.rl_pipeline.models import ANNPipeline, ANNDefinition
...
ann.forward(
    cards_features={3: torch.tensor([0., 0., 0.], requires_grad=True), 8: torch.tensor([1., 1., 1.], requires_grad=True)},
    hand_features=torch.tensor([1., 1., 1.], requires_grad=True),
